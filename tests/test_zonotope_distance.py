...
visZ([z2,z1],list_of_dimensions=[0,1],title="")
visZ([zonotope(z2.x,np.hstack((z2.G,D12*np.eye(z2.x.shape[0])))),z2,z1],title="",color_index=1)
visZ([zonotope(z1.x,np.hstack((z1.G,D21*np.eye(z1.x.shape[0])))),z1,z2],title="",color_index=0)