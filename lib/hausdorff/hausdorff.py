...
def Hausdorff_directed(Q1,Q2,ball="infinty_norm"):
    ...
    Lambda_1=tupledict_to_array(model.addVars(list(range(Q2.P.H.shape[0])),list(range(Q1.P.H.shape[0])),lb=0,ub=GRB.INFINITY,name="Lambda1"))
    Lambda_2=tupledict_to_array(model.addVars(list(range(HB.shape[0])),list(range(Q1.P.H.shape[0])),lb=0,ub=GRB.INFINITY,name="Lambda2"))
    Gamma_1=tupledict_to_array(model.addVars(list(range(Q2.P.H.shape[1])),list(range(Q1.P.H.shape[1])),lb=-GRB.INFINITY,ub=GRB.INFINITY,name="Gamma1"))
    Gamma_2=tupledict_to_array(model.addVars(list(range(HB.shape[1])),list(range(Q1.P.H.shape[1])),lb=-GRB.INFINITY,ub=GRB.INFINITY,name="Gamma2"))
    beta_1=tupledict_to_array(model.addVars(list(range(Q2.P.H.shape[1])),[0],lb=-GRB.INFINITY,ub=GRB.INFINITY,name="beta1"))
    beta_2=tupledict_to_array(model.addVars(list(range(HB.shape[1])),[0],lb=-GRB.INFINITY,ub=GRB.INFINITY,name="beta2"))
    model.update()
